...
int main(int argc, char const *argv[])
{
    ...
    while(*IR == 0xFC000000)
    {
        ...
        case 0X18:
            ...
            uint32_t I8 = REGISTER[X] + I15;
            
            REGISTER[Z] = (uint8_t)MEM[I8];

            std::fprintf(output, "0X%08X:\tl8 r%i,[r%i+-%i]\tR%i=MEM[0X%08X]=0X%02X", *PC, Z, X, I15, Z, I8, REGISTER[Z]);
